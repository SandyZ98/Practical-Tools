...
5. w: the overall sample weight. This was calculated by multiplying the inverse of the 1st and 2nd stage selection probabilities (from the original 3 stage design) with the inverse of the element level selection probability for each SSU (displayed above in Table 6). 

6. m: the number of sampled PSUs, which is 15

7. pp: a vector of PSU selection probabilities. These were calculated by multiplying the 1st and 2nd stage selection probabilities from the original 3-stage design.
